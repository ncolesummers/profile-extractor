...
def cleanup_resources(langsmith_client: Union[object, None] = None):
    ...
    if langsmith_client:
        ...
        try:
            ...
            flushed_ok = False
            if hasattr(langsmith_client, "flush") and callable(langsmith_client.flush):
            ...
            if (
                ...
                thread_pool_shutdown = True
                logger.debug("Nested LangSmith client thread pool shutdown initiated.")
            ...
            if hasattr(langsmith_client, "close") and callable(langsmith_client.close):
            ...
            logger.warning(f"Error during LangSmith client cleanup: {e}", exc_info=True)
    else:
